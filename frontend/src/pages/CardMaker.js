            ...
            <div className="flex-grow flex flex-col items-center justify-center text-black">
                <FadeIn>
                    ...
                    <div className="flex space-x-6">
                        ...
                        <Card imageUrl={`${process.env.PUBLIC_URL}/assets/image.png`} text="錄音工具"
                                  borderColor="border-blue-300" textColor="text-blue-300" link="https://vocaroo.com/" target="_blank" simple={true}/>
