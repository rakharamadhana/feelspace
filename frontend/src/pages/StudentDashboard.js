            ...
            <FadeIn>
                <div className="flex-grow flex flex-col items-center justify-center text-black">
                    ...
                    <div className="flex space-x-6">
                        ...
                        <Card imageUrl={`${process.env.PUBLIC_URL}/assets/menu-2.png`} text="桌遊專區" bgColor="bg-blue-300" textColor="text-white" link="#" />
                        <Card imageUrl={`${process.env.PUBLIC_URL}/assets/menu-3.png`} text="卡牌創作" bgColor="bg-green-300" textColor="text-white" link="#" />
                    </div>
                </div>
            </FadeIn>
        </div>
